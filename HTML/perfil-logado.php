...
?>
    ...
    <section class="dados-perfil">
        ...
        <h1 class="nome-perfil">Nome Completo da Silva <a href="atualizar-perfil.php">E</a></h1>
        <p>E-mail <a href="atualizar-perfil.php">E</a></p>
        <p>Senha (***) <a href="atualizar-perfil.php">E</a></p>
        <p>Sobre mim <a href="atualizar-perfil.php">E</a></p>
